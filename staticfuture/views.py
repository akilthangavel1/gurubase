    ...
    with connection.cursor() as cursor:
        ...
        if data:
            ...
            return {
                ...
                # 'high_low_60_min_bar_10_am_11_am': latest_data[2],
                # 'high_low_60_min_bar_11_am_12_pm': latest_data[3],
                # 'high_low_60_min_bar_12_pm_1_pm': latest_data[4],
                # 'high_low_60_min_bar_1_pm_2_pm': latest_data[5],
                # 'high_low_60_min_bar_2_pm_3_pm': latest_data[6],
                # 'high_low_60_min_bar_3_pm_4_pm': latest_data[7],
                # 'current_day_30_mins_top_with_date_and_time_of_the_bar': latest_data[8],
                # 'current_day_30_mins_bottom_with_date_and_time_of_the_bar': latest_data[9],
                # 'last_5_tops_in_30_mins_with_date_and_time_of_the_bar': latest_data[10],
                # 'last_5_bottoms_in_30_mins_with_date_and_time_of_the_bar': latest_data[11],
                # 'day_top_latest_1_with_date': latest_data[12],
                # 'day_top_previous_1_with_date': latest_data[13],
                # 'day_top_previous_2_with_date': latest_data[14],
                # 'highest_top_out_of_last_5_daily_tops_with_date': latest_data[15],
                # 'highest_top_out_of_last_10_daily_tops_with_date': latest_data[16],
                # 'highest_top_out_of_last_20_daily_tops_with_date': latest_data[17],
                # 'highest_top_out_of_last_40_daily_tops_with_date': latest_data[18],
                # 'day_bottom_latest_1_with_date': latest_data[19],
                # 'day_bottom_previous_1_with_date': latest_data[20],
                # 'day_bottom_previous_2_with_date': latest_data[21],
                # 'lowest_bottom_out_of_last_5_daily_bottoms_with_date': latest_data[22],
                # 'lowest_bottom_out_of_last_10_daily_bottoms_with_date': latest_data[23],
                # 'lowest_bottom_out_of_last_20_daily_bottoms_with_date': latest_data[24],
                # 'lowest_bottom_out_of_last_40_daily_bottoms_with_date': latest_data[25],
                # 'day_previous_swing_top_1_with_date': latest_data[26],
                # 'day_previous_swing_top_2_with_date': latest_data[27],
                # 'day_previous_swing_top_3_with_date': latest_data[28],
                # 'day_swing_bottom_1_with_date': latest_data[29],
                # 'day_previous_swing_bottom_2_with_date': latest_data[30],
                # 'day_previous_swing_bottom_3_with_date': latest_data[31],
                # 'previous_friday_high': latest_data[32],
                # 'previous_friday_low': latest_data[33],
                # 'previous_friday_close': latest_data[34],
                # 'expiry_week_open': latest_data[35],
                # 'expiry_week_high_low_volume_bar': latest_data[36],
                # 'expiry_week_high': latest_data[37],
                # 'expiry_week_low': latest_data[38],
                # 'expiry_week_vwap': latest_data[39],
                # 'expiry_week_close': latest_data[40],
                # 'rollover_week_open': latest_data[41],
                # 'roll_over_week_high_low_volume_bar': latest_data[42],
                # 'rollover_week_high': latest_data[43],
                # 'rollover_week_low': latest_data[44],
                # 'roll_over_week_vwap': latest_data[45],
                # 'rollover_week_close': latest_data[46],
                # 'week_top_latest_1_with_date': latest_data[47],
                # 'week_top_previous_1_with_date': latest_data[48],
                # 'week_top_previous_2_with_date': latest_data[49],
                # 'highest_top_out_of_last_4_weekly_tops_with_date': latest_data[50],
                # 'highest_top_out_of_last_8_weekly_tops_with_date': latest_data[51],
                # 'highest_top_out_of_last_12_weekly_tops_with_date': latest_data[52],
                # 'highest_top_out_of_last_16_weekly_tops_with_date': latest_data[53],
                # 'week_bottom_latest_1_with_date': latest_data[54],
                # 'week_bottom_previous_1_with_date': latest_data[55],
                # 'week_bottom_previous_2_with_date': latest_data[56],
                # 'lowest_bottom_out_of_last_4_weekly_bottoms_with_date': latest_data[57],
                # 'lowest_bottom_out_of_last_8_weekly_bottoms_with_date': latest_data[58],
                # 'lowest_bottom_out_of_last_12_weekly_bottoms_with_date': latest_data[59],
                # 'lowest_bottom_out_of_last_16_weekly_bottoms_with_date': latest_data[60],
                # 'month_top_1_with_date': latest_data[61],
                # 'month_top_2_with_date': latest_data[62],
                # 'month_top_3_with_date': latest_data[63],
                # 'highest_top_out_of_last_2_monthly_tops_with_date': latest_data[64],
                # 'highest_top_out_of_last_4_monthly_tops_with_date': latest_data[65],
                # 'highest_top_out_of_last_6_monthly_tops_with_date': latest_data[66],
                # 'month_bottom_1_with_date': latest_data[67],
                # 'month_bottom_2_with_date': latest_data[68],
                # 'month_bottom_3_with_date': latest_data[69],
                # 'lowest_bottom_out_of_last_2_monthly_bottoms_with_date': latest_data[70],
                # 'lowest_bottom_out_of_last_4_monthly_bottoms_with_date': latest_data[71],
                # 'lowest_bottom_out_of_last_6_monthly_bottoms_with_date': latest_data[72]
            }
        return None
